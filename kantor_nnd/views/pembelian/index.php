...
<html lang="en">
  <head>
    ...
    <title>Pembelian - Konterku</title>
  ...
  <body>
        ...
        <div class="card">
            <div class="card-header">
                <div class="row">
                    <div class="col col-sm-9">PEMBELIAN</div>
                    <div class="col col-sm-3">
                        <a href="http://localhost:81/Nadyaaptr/kantor_nnd/views/Pembelian/add.php" class="btn btn-success btn-sm float-end">Add</a>
                    </div>
                </div>
            </div>
            <div class="card-body">
                ...
                <div class="modal-content">
                    <form method="post" id="sample_form">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="mb-3">
                                <label class="form-label">nm_supplier</label>
                                <input type="nm_supplier" name="nm_supplier" id="nm_supplier" class="form-control" />
                                <span id="nm_supplier_error" class="text-danger"></span>
                            </div>
                            <div class="mb-3">
    ...
    $(document).ready(function() {
        ...
        $('#add_data').click(function(){
            $('#dynamic_modal_title').text('Add Data Pembelian');
            $('#sample_form')[0].reset();
            $('#action').val('Add');
        ...
        $('#sample_form').on('submit', function(event){
            ...
            if($('#action').val() == "Add"){
                ...
                $.ajax({
                    url:"http://localhost:81/Nadyaaptr/kantor_nnd/api/Pembelian/update.php",
                    method:"PUT",
                    data: JSON.stringify(formData),
                    success:function(data){
                        $('#action_button').attr('disabled', false);
    ...
    function showAll() {
        $.ajax({
            ...
            url:"http://localhost:81/Nadyaaptr/kantor_nnd/api/Pembelian/read.php",
            ...
            // console.log(response);
                ...
                for (var i = 0; i < json.length; i++) {
                    var sub_array = {
                        ...
                        'nm_supplier' : json[i].nm_supplier,
                        'kasir' : json[i].kasir,
    ...
    function showOne(id) {
        ...
        $.ajax({
            ...
            contentType: "application/json",
            url:
            "http://localhost:81/Nadyaaptr/kantor_nnd/api/Pembelian/read.php?id="+id,
            success: function(response) {
                $('#id').val(response.id);
                $('#trxid').val(response.trxid);
                $('#date_sell').val(response.date_sell).change();
                $('#nm_supplier').val(response.nm_supplier);
    ...
    function deleteOne(trxid) {
        ...
        $.ajax({
            url:"http://localhost:81/Nadyaaptr/kantor_nnd/api/Pembelian/delete.php",
            method:"DELETE",
