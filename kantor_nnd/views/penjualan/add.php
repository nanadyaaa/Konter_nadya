    ...
    <div class="container">
        ...
        <div class="container px-4">
            <form class="row g-1" id="sample_form">
                <div class="col-md-6">
                    <label for="trxid" class="form-label">NOTRX</label>
                ...
                <div class="col-md-6">
                    <label for="nm_customer" class="form-label">Customer</label>
                    <input type="text" class="form-control" id="nm_customer" placeholder="John Doe">
                </div>
            ...
            $('#sample_form').on('submit', function(event){
                ...
                $.ajax({
                    ...
                    success:function(data){
                        ...
                        window.location.href = 'http://localhost:81/Nadyaaptr/kantor_nnd/views/penjualan/';
                    },
                    error: function(err) {
                        console.log(err);   
